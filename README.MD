...
#### Foquei em construir um frontend preparado para integrar com o backend. Para simular o backend, fiz a API mock e, assim, deixar o frontend mais fácil de ser integrado à uma "api oficial".
---
